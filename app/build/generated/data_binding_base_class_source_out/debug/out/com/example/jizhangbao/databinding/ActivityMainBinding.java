...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout main,
      @NonNull BottomNavigationView mainBottomNavigation, @NonNull Toolbar mainToolbar,
      @NonNull ViewPager2 mainVp2) {
    this.rootView = rootView;
    this.main = main;
    this.mainBottomNavigation = mainBottomNavigation;
    this.mainToolbar = mainToolbar;
    this.mainVp2 = mainVp2;
  }
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.main_vp2;
      ViewPager2 mainVp2 = ViewBindings.findChildViewById(rootView, id);
      if (mainVp2 == null) {
        break missingId;
      }

      return new ActivityMainBinding((LinearLayout) rootView, main, mainBottomNavigation,
          mainToolbar, mainVp2);
    }
